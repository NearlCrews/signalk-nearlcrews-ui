...
Repository checks include full and production dependency audits, Dependabot, CodeQL default setup for JavaScript/TypeScript and GitHub Actions workflows, SHA-pinned GitHub Actions, type-aware linting, Knip, the Signal K host-contract check, packed-package inspection, React and React DOM externalization checks, browser accessibility tests, and npm provenance.
